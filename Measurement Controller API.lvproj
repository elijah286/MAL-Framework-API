...
<Project Type="Project" LVVersion="16008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Controller API.lvlib" Type="Library" URL="../Controller API.lvlib"/>
		<Item Name="Measurement Controller API Example.vi" Type="VI" URL="../Msmt API Example/Measurement Controller API Example.vi"/>
		<Item Name="MeasurementConfig.ini" Type="Document" URL="../Msmt API Example/MeasurementConfig.ini"/>
