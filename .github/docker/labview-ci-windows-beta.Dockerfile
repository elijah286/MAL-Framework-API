# escape=`
# =============================================================================
# LabVIEW CI Windows BETA base image (one-time rebase of the core Windows base; diverges as experimental capabilities are added)
# =============================================================================
...
LABEL com.cotc.ci-base.kind=labview-ci `
      com.cotc.ci-base.platform=windows-beta